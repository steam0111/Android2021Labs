...
public class CloudAnchorManager {
    ...
    public synchronized void hostCloudAnchor(
        ...
        Anchor newAnchor = session.hostCloudAnchorWithTtl(anchor, 1);
    ...
    public synchronized void resolveCloudAnchor(
        ...
        Log.d("qwerty", "resolveCloudAnchor anchorId" + anchorId);
    ...
    public synchronized void onUpdate() {
        ...
        while (iter.hasNext()) {
            ...
            Log.d("qwerty", "isReturnableState " + anchor.getCloudAnchorState());
